...
$title = $_SESSION['add-post-data']['username'] ?? null;
$body = $_SESSION['add-post-data']['email'] ?? null;
        ...
        <div class="container form_section-container">
            ...
            <?php if(isset($_SESSION['add-post'])) : ?>
               <div class="alert_message success">
                ...
                <?php endif ?>
            <form action="add_article_logic.php" method="POST" enctype="multipart/form-data">
                <input type="text" name="title" value= "<?= $title ?>" placeholder="Title">
                <textarea rows="10" name="body" value= "<?= $body ?>" placeholder="Body"></textarea>
                <input type="text" name="url" value="<?= $url ?? '' ?>" placeholder="URL of the source">
